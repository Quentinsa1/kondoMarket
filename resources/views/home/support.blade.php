...
<div class="support-page">
    <!-- Hero simple pour la page support -->
    ...
    <!-- Cartes de contact direct (Mail, WhatsApp, Appel) -->
    <section class="py-5">
        <div class="container-xxl">
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm text-center p-4">
                        <div class="card-body">
                            ...
                            <a href="mailto:contact@aslazmarket.com" class="btn btn-outline-primary rounded-pill px-4">Envoyer un mail</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm text-center p-4">
                        <div class="card-body">
                            ...
                            <a href="https://wa.me/+2290154936191" class="btn btn-outline-success rounded-pill px-4" target="_blank">Démarrer la discussion</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm text-center p-4">
                        <div class="card-body">
                            ...
                            <a href="tel:+2290154936191" class="btn btn-outline-warning rounded-pill px-4">Appeler maintenant</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Formulaire de contact support général -->
    <section class="py-5">
        <div class="container-xxl">
            <div class="row">
                <div class="col-lg-8 mx-auto">
