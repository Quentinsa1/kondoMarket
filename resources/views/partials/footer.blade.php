        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="#">Services vendeurs</a></li>
                    <li><a href="#">Outils de vente</a></li>
                    <li><a href="#">Ressources</a></li>
                    <li><a href="#">Centre vendeur</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="#">Inspection qualité</a></li>
                    <li><a href="#">Financement</a></li>
                    <li><a href="#">Assurance commerce</a></li>
                    <li><a href="#">Services douaniers</a></li>
                </ul>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <div class="payment-methods">
                        ...
                        <div class="payment-method">Wise</div>
                    </div>
                </div>
            </div>
        </div>
